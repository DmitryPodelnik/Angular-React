            ...
            builder.HasData(
                new User[]
                {
                    new User { Id = 1, FirstName = "Dmitry", LastName = "Podelnik", Username = "dmitrypodelnik", Email = "dmitrypodelnik.developer@gmail.com",
                               ...
                               Role = "user", About = "Учёный-энциклопедист: химик, физикохимик, физик, метролог, экономист, технолог, геолог, метеоролог, нефтяник, педагог, воздухоплаватель, " +
                    ...
                    new User { Id = 2, FirstName = "Dmitry2", LastName = "Podelnik2", Username = "dmitrypodelnik2", Email = "dmitrypodelnik2.developer@gmail.com",
                               ...
                               Role = "user", About = "Христианский богослов и философ, влиятельнейший проповедник, епископ Гиппонский (с 395 года), один из Отцов христианской церкви" +
                    ...
                    new User { Id = 3, FirstName = "Dmitry3", LastName = "Podelnik3", Username = "dmitrypodelnik3", Email = "dmitrypodelnik3.developer@gmail.com",
                               ...
                               Role = "user", About = "Американский предприниматель и общественный деятель, филантроп, один из создателей (совместно с Полом Алленом) и бывший " +
